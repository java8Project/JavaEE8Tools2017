...
<head prefix="og: http://ogp.me/ns#">
    ...
    <link rel="stylesheet" media="all" href="http://localhost/jsLib/gitlab/1.css"/>
    <link rel="stylesheet" media="print" href="http://localhost/jsLib/gitlab/2.css"/>
    <script src="http://localhost/jsLib/gitlab/1.js"></script>
    <meta name="csrf-param" content="authenticity_token"/>
    <meta name="csrf-token" content="fo9TdTJMeHBHSMHWAbKMp8UAYJGK8Ls4tL/JKmsRKXBAY5n3f6P6IR/6g/P66KVTCK2y9kUBIrTKDC5GoMyc4w=="/>
...
<div class="page-wrap">
    <script>
        ...
        window.gon = {};
        gon.api_version = "v3";
        gon.default_avatar_url = "https:\/\/gitlab.com\/assets\/no_avatar-849f9c04a3a0d0cea2424ae97b27447dc64a7dbfae83c036c45b403392f0e8ba.png";
        gon.max_file_size = 10;
        gon.relative_url_root = "";
        gon.shortcuts_path = "\/help\/shortcuts";
        gon.user_color_scheme = "white";
        gon.award_menu_url = "\/emojis";
        gon.katex_css_url = "\/assets\/katex-e46cafe9c3fa73920a7c2c063ee8bb0613e0cf85fd96a3aea25f8419c4bfcfba.css";
        gon.katex_js_url = "\/assets\/katex-04bcf56379fcda0ee7c7a63f71d0fc15ffd2e014d017cd9d51fd6554dfccf40a.js";
        //]]>
    </script>
    ...
    <div class="container navless-container">
        <div class="content">
                        ...
                        <div class="tab-content">
                            <div class="login-box tab-pane active" id="login-pane" role="tabpanel">
                                <div class="login-body">
                                    <form class="new_user gl-show-field-errors" aria-live="assertive" id="new_user" action="/users/sign_in" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;"/><input type="hidden" name="authenticity_token" value="l+cNY5mdFBjAiFZHbfHfw7dp0ptSFJHMEHUc3BIscT+pC8fh1HKWSZg6FGKWq/Y3esQA/J3lCEBuxvuw2fHErA=="/>
                            ...
                            <div class="login-box tab-pane" id="register-pane" role="tabpanel">
                                <div class="login-body">
                                    <form class="new_new_user gl-show-field-errors" aria-live="assertive" id="new_new_user" action="/users" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;"/><input type="hidden" name="authenticity_token" value="aYu67mVCWdTO8ZY7s63DxNmzUKC5bK37r7/cA55hAC5XZ3BsKK3bhZZD1B5I9+owFB6Cx3adNHfRDDtvVby1vQ=="/>
            ...
            Sign in with &nbsp;
                                    ...
                                    <span class="light">
            <a class="oauth-image-link" data-no-turbolink="true" rel="nofollow" data-method="post" href="/users/auth/google_oauth2">
        <img alt="Google" title="Sign in with Google" src="http://localhost/jsLib/google.png"/></a>
            </span>
                                    <span class="light">
            <a class="oauth-image-link" data-no-turbolink="true" rel="nofollow" data-method="post" href="/users/auth/twitter">
        <img alt="Twitter" title="Sign in with Twitter" src="http://localhost/jsLib/twitter.png"/></a>
            </span>
                                    <span class="light">
            <a class="oauth-image-link" data-no-turbolink="true" rel="nofollow" data-method="post" href="/users/auth/github">
        <img alt="GitHub" title="Sign in with GitHub" src="http://localhost/jsLib/github.png"/></a>
            </span>
                                    <span class="light">
            <a class="oauth-image-link" data-no-turbolink="true" rel="nofollow" data-method="post" href="/users/auth/bitbucket">
        <img alt="Bitbucket" title="Sign in with Bitbucket" src="http://localhost/jsLib/bitbucket.png"/></a>
            </span>
                                </p>
                            </div>
                        </div>
                ...
                <div class="col-sm-7 brand-holder pull-left">
                    ...
                    <p dir="auto"><strong>GitLab.com offers free unlimited (private) repositories and unlimited collaborators, please sign up or in on the right.</strong></p>

                    <ul dir="auto">
                        <li>
                            <a href="https://gitlab.com/explore/projects/trending">Explore projects on GitLab.com</a> (no login needed)
                        </li>
                    ...
                    <ul dir="auto">
                        ...
                        <li>
                            <a href="https://about.gitlab.com/terms/#gitlab_com" rel="nofollow noreferrer" target="_blank">GitLab.com Terms</a>.
                        </li>
                    </ul>
                </div>
            </div>
